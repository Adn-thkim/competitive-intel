...
§1-4에서 언급한 대로 단일 2축 맵은 페르소나를 평균화합니다. Gartner Critical Capabilities (`reference/comparison_matrix.md` §1-3 인용)와 동일 원리로, **페르소나별로 같은 5개 카드를 다른 좌표 평면에 배치**해야 의미가 있습니다.
...
참조: [Mindtools — Perceptual Mapping](https://www.mindtools.com/a1iixrj/perceptual-mapping/), `reference/comparison_matrix.md` §1-3 Gartner Critical Capabilities
